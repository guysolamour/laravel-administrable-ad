...
namespace Guysolamour\Administrable\Extensions\Ad\Models;
...
class Ad extends BaseModel implements HasMedia
{
    ...
    {
        return $this->belongsTo(config('administrable-ad.models.type'), 'type_id');
    }

    public function group()
    {
        return $this->belongsTo(config('administrable-ad.models.group'), 'group_id');
    }
