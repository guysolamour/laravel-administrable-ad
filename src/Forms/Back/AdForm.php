...
namespace Guysolamour\Administrable\Extensions\Ad\Forms\Back;
...
class AdForm extends Form
{
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('type_id', 'entity', [
                "class" => config('administrable-ad.models.type'),
            ...
            ->add('group_id', 'entity', [
                "class" => config('administrable-ad.models.group'),
                'empty_value' => "Choisir le groupe",
                "property" => 'name',
                "label" => 'Groupe de pubs',
                "rules" => 'nullable|exists:extensions_ad_groups,id',
                'attr' => [
                    'class' => 'custom-select select2'
                ]
