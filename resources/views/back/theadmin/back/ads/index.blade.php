                ...
                <table class="table table-hover table-has-action" id='list'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" data-check class="form-check-input" data-id="{{ $ad->id }}"
                                        id="check-{{ $ad->id }}">
                                    <label class="form-check-label" for="check-{{ $ad->id }}"></label>
                                </div>
                            </td>
                            <td>{{ $ad->getKey() }}</td>
                            <td>{{ $ad->name }}</td>
                            ...
                            <td>
                               <nav class="nav no-gutters gap-2 fs-16">
                                    ...
                                    <a class="nav-link hover-primary" href="{{ back_route('extensions.ads.ad.edit', $ad) }}"
                                        data-provide="tooltip" title="Editer"><i
                                            class="ti-pencil"></i></a>
                                    <a class="nav-link hover-danger" href="{{ back_route('extensions.ads.ad.destroy', $ad) }}" data-provide="tooltip" title=""
                                        data-method="delete"
